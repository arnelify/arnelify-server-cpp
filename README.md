...
![Arnelify](https://img.shields.io/badge/Arnelify%20Server%20for%20C++-0.5.4-yellow) ![C++](https://img.shields.io/badge/C++-23.0-red)
...
We are excited to introduce the Arnelify Server v0.5.4 package! Please note that this version is raw and still in active development. It includes only basic features, and the framework has not yet undergone thorough testing.
...
* <a href="https://github.com/arnelify/arnelify-pod-cpp">Arnelify POD for C++ Framework v0.5.4</a>
* <a href="https://github.com/arnelify/arnelify-pod-python">Arnelify POD for Python Framework v0.5.4</a>
* <a href="https://github.com/arnelify/arnelify-pod-node">Arnelify POD for Node Framework v0.5.4</a>
* <a href="https://github.com/arnelify/arnelify-react-native">Arnelify React Native v0.5.4</a>